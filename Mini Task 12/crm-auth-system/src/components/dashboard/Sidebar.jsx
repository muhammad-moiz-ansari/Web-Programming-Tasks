...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-[#1e293b] flex flex-col shrink-0">
      {/* Logo */}
      <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-700">
        ...
        <div>
          <p className="text-white font-bold text-sm leading-tight">CRM System</p>
      ...
      <div className="px-4 py-4 border-t border-slate-700">
        <p className="text-slate-500 text-xs text-center">© 2024 CRM System</p>
      </div>
    </aside>
  );
}
